...
Status copy_bmp_header(FILE *fpt_src_image, FILE *fptr_stego_image){
    rewind(fpt_src_image);
    char arr[54];

    fread(arr, 54, 1, fpt_src_image);
